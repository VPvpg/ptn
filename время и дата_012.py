...
Кнопки для увеличения/уменьшения шрифта.
"""
...
font_plus_button = tk.Button(button_frame, text="Увеличить шрифт", command=lambda: change_font_size(2))
font_plus_button.pack(side=tk.LEFT, padx=5)

font_minus_button = tk.Button(button_frame, text="Уменьшить шрифт", command=lambda: change_font_size(-2))
